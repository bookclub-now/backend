defmodule Bookclub.MixProject do
  ...
  defp deps do
    [
      ...
      {:distillery, "~> 2.0"},
      # HACK: Should `config :postgrex, :json_library, Jason`.
      # But it's a known issue with Elixir 1.7:
      # https://github.com/elixir-lang/elixir/issues/7930
      #
      # It will fail sometimes unless we add Poison.
      # When bumping verions check for removing it.
      {:poison, "~> 3.0"},
